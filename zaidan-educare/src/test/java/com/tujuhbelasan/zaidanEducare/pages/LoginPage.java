...
//        return driver.findElement(errorMessage).getText();
        ...
        /**
     * Memeriksa apakah halaman login ditampilkan
     * @return true jika halaman login ditampilkan, false jika tidak
     */
    public boolean isLoginPageDisplayed() {
        try {
            WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
            // Periksa berdasarkan elemen form login atau elemen-elemen khas halaman login
